<?php
// Heading
$_['heading_title'] = 'Checkbox (фіскальні чеки)';
...
$_['entry_client_version'] = 'X-Client-Version';
$_['entry_auto_enabled'] = 'Автоматичний режим';
...
// Error
$_['error_permission'] = 'У вас немає прав для зміни налаштувань модуля Checkbox!';
$_['error_name'] = 'Назва модуля має бути від 3 до 64 символів!';
$_['error_api_url'] = 'Невірний API URL!';
