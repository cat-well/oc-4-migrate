...
$_['entry_np_cod_total']            = 'COD amount (UAH)';
...
$_['entry_np_sender_address']       = 'Ship from';
$_['text_np_sender_default']        = 'Default (from NP account)';
$_['text_np_sender_hint']           = 'If your Nova Poshta account has more than one address, pick which one this order ships from. When left empty the first Warehouse-type address from your NP account is used.';
